...
public class UserDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv_repositories = findViewById(R.id.tv_repositories);
        ...
        tv_repositories.setText("Repositories : " + getIntent().getStringExtra("Repository"));
        tv_company.setText("Company   : " + getIntent().getStringExtra("Company"));
