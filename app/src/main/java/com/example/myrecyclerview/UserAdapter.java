    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "This is my text to send."+ users.get(holder.getAdapterPosition()).getUserName());
        ...
        holder.cvCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra("Company", user.getCompany());
                sendIntent.putExtra("Repository", user.getRepository());
